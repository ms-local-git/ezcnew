            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="card">
                     ...
                     <div class="card-body">
                        <form action="<?= base_url('User/update/' . $row['id_1']) ?>" method="POST" enctype="multipart/form-data">
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="card">
                                    <div class="card-header">
                                                         ...
                                                         <select name="role_id" id="role_id" class="form-control">
                                                            <?php if (!empty($roles)): ?>
                                                               <?php foreach ($roles as $role): ?>
                                                                  <option value="<?= esc($role['id']) ?>" <?= ((int)($row['role_id'] ?? 0) === (int)$role['id']) ? 'selected' : '' ?>>
                                                                     <?= esc($role['name']) ?>
                                                                  </option>
                                                               <?php endforeach; ?>
                                                            <?php else: ?>
                                                ...
                                                <div class="row">
                                                   ...
                                                   <div class="col-sm-9 col-6">
                                                      <div class="custom-control custom-checkbox">
                                                         <input type="checkbox" class="custom-control-input" name="two_hour_popup" value="1" <?= !empty($row['two_hour_popup']) ? 'checked' : '' ?>>
                                                ...
                                                <div class="row">
                                                   ...
                                                   <div class="col-sm-9 col-6">
                                                      <div class="custom-control custom-radio custom-control-inline">
                                                         <input type="radio" id="statusActive" name="user_slevel" class="custom-control-input" value="1" <?= !empty($row['user_slevel']) ? 'checked' : '' ?>>
                                                         <label class="custom-control-label" for="statusActive">Active</label>
                                                      </div>
                                                      <div class="custom-control custom-radio custom-control-inline">
                                                         <input type="radio" id="statusInactive" name="user_slevel" class="custom-control-input" value="0" <?= empty($row['user_slevel']) ? 'checked' : '' ?>>
                                          ...
                                          <div class="col-sm-6 col-12">
                                             <div class="form-group">
                                                <div class="row">
                                                   ...
                                                   <div class="col-sm-9 col-6">
                                                      <div class="custom-control custom-radio custom-control-inline">
                                                         <input type="radio" id="sessionValidationYes" name="retry" class="custom-control-input" value="1" <?= !empty($row['retry']) ? 'checked' : '' ?>>
                                                         <label class="custom-control-label" for="sessionValidationYes">Yes</label>
                                                      </div>
                                                      <div class="custom-control custom-radio custom-control-inline">
                                                         <input type="radio" id="sessionValidationNo" name="retry" class="custom-control-input" value="0" <?= empty($row['retry']) ? 'checked' : '' ?>>
                                          ...
                                          <div class="col-sm-6 col-12">
                                             <div class="form-group">
                                                <div class="row">
                                                   ...
                                                   <div class="col-sm-9 col-6">
                                                      <div class="custom-control custom-radio custom-control-inline">
                                                         <input type="radio" id="webcamEnableYes" name="is_webcam" class="custom-control-input" value="1" <?= !empty($row['is_webcam']) ? 'checked' : '' ?>>
                                                         <label class="custom-control-label" for="webcamEnableYes">Yes</label>
                                                      </div>
                                                      <div class="custom-control custom-radio custom-control-inline">
                                                         <input type="radio" id="webcamEnableNo" name="is_webcam" class="custom-control-input" value="0" <?= empty($row['is_webcam']) ? 'checked' : '' ?>>
                                          ...
                                          <div class="col-sm-6 col-12">
                                             <div class="form-group">
                                                <div class="row">
                                                   ...
                                                   <div class="col-sm-9 col-6">
                                                      <div class="custom-control custom-radio custom-control-inline">
                                                         <input type="radio" id="allowBreakYes" name="is_lunch" class="custom-control-input" value="1" <?= !empty($row['is_lunch']) ? 'checked' : '' ?>>
                                                         <label class="custom-control-label" for="allowBreakYes">Yes</label>
                                                      </div>
                                                      <div class="custom-control custom-radio custom-control-inline">
                                                         <input type="radio" id="allowBreakNo" name="is_lunch" class="custom-control-input" value="0" <?= empty($row['is_lunch']) ? 'checked' : '' ?>>
                                          ...
                                          <div class="col-sm-6 col-12">
                                             <div class="form-group">
                                                <div class="row">
                                                   ...
                                                   <div class="col-sm-9 col-6">
                                                      <div class="custom-control custom-radio custom-control-inline">
                                                         <input type="radio" id="showSessionYes" name="is_session_show" class="custom-control-input" value="1" <?= !empty($row['is_session_show']) ? 'checked' : '' ?>>
                                                         <label class="custom-control-label" for="showSessionYes">Yes</label>
                                                      </div>
                                                      <div class="custom-control custom-radio custom-control-inline">
                                                         <input type="radio" id="showSessionNo" name="is_session_show" class="custom-control-input" value="0" <?= empty($row['is_session_show']) ? 'checked' : '' ?>>
                                          ...
                                          <div class="col-sm-6 col-12">
                                             <div class="form-group">
                                                <div class="row">
                                                   ...
                                                   <div class="col-sm-9 col-6">
                                                      <div class="custom-control custom-radio custom-control-inline">
                                                         <input type="radio" id="indiaPayrollYes" name="is_payroll" class="custom-control-input" value="1" <?= !empty($row['is_payroll']) ? 'checked' : '' ?>>
                                                         <label class="custom-control-label" for="indiaPayrollYes">Yes</label>
                                                      </div>
                                                      <div class="custom-control custom-radio custom-control-inline">
                                                         <input type="radio" id="indiaPayrollNo" name="is_payroll" class="custom-control-input" value="0" <?= empty($row['is_payroll']) ? 'checked' : '' ?>>
                                          ...
                                          <div class="col-sm-6 col-12">
                                             <div class="form-group">
                                                <div class="row">
                                                   ...
                                                   <div class="col-sm-9 col-6">
                                                      <input type="text" class="form-control" name="whatsapp_number" value="<?= $row['whatsapp_number'] ?? '' ?>">
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-sm-6 col-12">
                                             <div class="form-group">
                                                <div class="row">
                                                   ...
                                                   <div class="col-sm-9 col-6">
                                                      <input type="text" class="form-control" name="hour_rate_day" value="<?= $row['hour_rate_day'] ?? '' ?>">
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-sm-6 col-12">
                                             <div class="form-group">
                                                <div class="row">
                                                   ...
                                                   <div class="col-sm-9 col-6">
                                                      <input type="text" class="form-control" name="hour_rate_night" value="<?= $row['hour_rate_night'] ?? '' ?>">
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
                                                ...
                                                <div class="row">
                                                   ...
                                                   <div class="col-sm-9 col-6">
                                                      <select name="page_id" class="form-control">
                                                         <option value="0" <?= ((int)($row['page_id'] ?? 0) === 0) ? 'selected' : '' ?>>Order Quality Window</option>
                                                      </select>
                                                   </div>
                                                </div>
                                             </div>

            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Users Listing</h2>
                                        ...
                                        <tbody id="searchContent">
                                            ...
                                            if (isset($user))
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $r['role_name'] ?? '-' ?></td>
                                                    <td><?= $r['department'] ?> </td>
                                                    <td><a href="user/edit/<?= $r['user_id'] ?>"><button type="button" class="btn btn-primary btn-sm">Edit</button></a></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>

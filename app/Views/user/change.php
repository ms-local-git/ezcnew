               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="card">
                        ...
                        <div class="card-body">
                           <form action="<?= base_url() ?>/User/changep" method="POST" enctype="multipart/form-data">
                           <div class="row">
                     <div class="col-md-12">
                        <div class="card">
                              ...
                              <div class="row">
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       ...
                                       <label for="valid-state" style="text-align: right;">User Name:</label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                                       <input type="hidden" name="id" class="form-control" value="<?= $row['user_id'] ?>">
                              ...
                              <div class="row">
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state" style="text-align: right;">Current Password:</label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                              ...
                              <div class="row">
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state" style="text-align: right;">New Password:</label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                                       <input type="password" name="npassword" id="password" required class="form-control">
                                      </div>
                                        </div>
                                    </div>
                                 </div>
                              ...
                              <div class="row">
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state" style="text-align: right;">New Master Password:</label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                                       <input type="password" name="confirm_pass" id="confirm_password" required class="form-control">
                                      </div>
                                        </div>
                                    </div>
                                 </div>
                              ...
                              <div class="row">
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state" style="text-align: right;">Change Profile</label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                     ...
                     <button class="btn btn-primary" name="submit" type="submit" style="width: 100%;
                        height: max-content;

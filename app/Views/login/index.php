...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>/assets/app/css/plugins/forms/form-validation.css">
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>/assets/app/css/pages/page-auth.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="javascript:void(0);" class="brand-logo">
                                    <img  src="<?=base_url()?>/assets/images/logo.jpg" style="width: 300px;" >
                                ...
                                <form class="auth-login-form mt-2" action="<?= base_url() ?>/login/check" method="POST">
    ...
    <script src="<?=base_url()?>/assets/app/vendors/js/forms/validation/jquery.validate.min.js"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?=base_url()?>/assets/app/js/scripts/pages/page-auth-login.js"></script>
    <!-- END: Page JS-->

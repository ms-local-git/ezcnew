      ...
      <div class="app-content content ">
         ...
         <div class="content-wrapper container-xxl p-0">
            ...
            <section name="invoice-printout">
               <div class="row">
                  <div class="col-md-12">
                  <h2 class="content-header-title float-left mb-0">New Bank</h2>
                  </div>
               </div><br>
               <div class="row">
                  <div class="col-md-12">
                     <div class="card">
                        ...
                        <div class="card-body">
                           <form action="<?= base_url() ?>/checks/bank_save" method="POST" >
                           ...
                           <div class="card-body">
                              ...
                              <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       ...
                                       <label for="valid-state">Account No:<span style="color:red">*</span></label>
                                       </div>
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state">Account Holder:<span style="color:red">*</span></label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state">Bank Name:<span style="color:red">*</span></label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state">Opening Balance:<span style="color:red">*</span></label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                                       <input type="text" class="form-control" name="opening_bal" required="">
                                      </div>
                                        </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-sm-3 col-12 pt-2">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="default" name="is_default" value="1" />

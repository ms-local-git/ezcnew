            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Agents</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                   
                                    <li class="breadcrumb-item active">Paid Jobs
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card py-1 px-4" id="searchBox">
                            <form id="searchForm" action="<?= base_url() ?>/agent/paid_jobs" method="post">
                                <div class="row">
                                    <label class="col-md-2"><h3>Search Filter</h3></label>
                                    <input type="text" name="txt" id="searchVal" class="form-control col-md-8" value="<?= $request->getPost("txt"); ?>">
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-10">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="agent" name="option" checked value="agent" class="custom-control-input"  />
                                                        <label class="custom-control-label" for="agent">Agent Code</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="job" name="option" value="job" <?php if($request->getPost("option")=='job') echo "checked"; ?> class="custom-control-input"  />
                                                        <label class="custom-control-label" for="job">Job No.</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="invoice" name="option" value="invoice" <?php if($request->getPost("option")=='invoice') echo "checked"; ?> class="custom-control-input"  />
                                                        <label class="custom-control-label" for="invoice">Inv No.</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="check" name="option" value="check" <?php if($request->getPost("option")=='check') echo "checked"; ?> class="custom-control-input"  />
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="amount" name="option" value="amount" <?php if($request->getPost("option")=='amount') echo "checked"; ?> class="custom-control-input"  />
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="sett" name="option" value="sett" <?php if($request->getPost("option")=='sett') echo "checked"; ?> class="custom-control-input"  />
                                                        <label class="custom-control-label" for="sett">Sett. No.</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card-datatable">
                                ...
                                <table class="datatables-basic table">
                                    ...
                                    <tbody id="searchContent">
                                        ...
                                        <tr>
                                            <td><?= $r["code"] ?> - <?= substr($r["agent_name"],0,15) ?></td>
                                            <td><?= $r["invoice_no"] ?></td>
                                            <td><?= $r["job_no"] ?></td>
                                            <td>$ <?= $r["charges"] ?></td>

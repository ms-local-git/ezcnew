...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0" style="border-right: none;">BPT Directory</h2>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-12">
                    <div class="card folder-grid-card">
                        <div class="card-body loader-2">
                            <div class="row">
                                <?php if (!empty($bpt_records)): ?>
                                    <?php foreach ($bpt_records as $bptdir): ?>
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                                            <a href="<?= base_url('bpt/' . $bptdir['id']) ?>" class="folder_link loaderbtn load-page">
                                                <div class="folder_icons">
                                                    <i class="fa fa-folder folder_icon_visual"></i>
                                                    <h4 class="file_name"><?= esc($bptdir['name']) ?></h4>
                                                </div>
                                            </a>
                                        </div>
                                    <?php endforeach; ?>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('addbptdir') ?>" method="post" enctype="multipart/form-data">
                    <div class="row">

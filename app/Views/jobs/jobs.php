      ...
      <div class="app-content content ">
         ...
         <div class="content-wrapper container-xxl p-0">
            ...
            <section name="invoice-printout">
               <div class="row">
                  <div class="col-md-12">
                  <h2 class="content-header-title float-left mb-0">Jobs Refference:</h2>
                  </div>
               </div><br>
               <div class="row">
                  <div class="col-md-12">
                     <div class="card">
                        <div class="card-header">
                           <div>
                              <h4 class="card-title">Jobs Information:</h4>
                              <br/>
                           </div>
                        </div>
                        <div class="card-body">
                           ...
                           <div class="card-body">
                              ...
                              <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       ...
                                       <label for="valid-state">Jobs#:<span style="color:red">*</span></label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                                       <input type="text" class="form-control" name="job_no" required="">
                                      </div>
                                        </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                         <div class="col-sm-3 col-6">
                                           <label for="valid-state">Refference:<span style="color:red">*</span></label>
                                         </div>
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state">Account Name:</label>
                                       </div>
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state">New Refference:</label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                                       <input type="text" class="form-control" name="new_reff" required="">
                                      </div>
                                        </div>
                                    </div>
                                 </div>

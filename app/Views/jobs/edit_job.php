    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
            <section id="new-client">
                <form method="post" action="<?= base_url() ?>/jobs/update_job">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="custom-control custom-radio" style="display:inline;padding:0 30px">
                                            <input name="branch"  <?php if($b['branch_html_val']==$job->branch) echo "checked"; ?> id="<?=$b['branch_html_val']?>" class="custom-control-input" type="radio" value="<?=$b['branch_html_val']?>">
                                        ...
                                        <div class="input-group mb-1 row">
                                            <div class="col-md-3"> -->
                                                <div class="custom-control custom-radio" style="display:inline;padding:0 30px">
                                                    ...
                                                    <?php if($job->job_type_2=='Cargo Van') echo "checked"; ?> value="Cargo Van"
                                                        class="custom-control-input" />
                                            ...
                                            <div class="col-md-3"> -->
                                                <div class="custom-control custom-radio" style="display:inline;padding:0 30px">
                                                    <input type="radio" id="truck" name="job_type_2"
                                                        <?php if($job->job_type_2=='Truck Jobs') echo "checked"; ?>
                                            ...
                                            <div class="col-md-3"> -->
                                                <div class="custom-control custom-radio" style="display:inline;padding:0 30px">
                                                    <input type="radio" id="del" name="job_type_2"
                                                        <?php if($job->job_type_2=='Hot Deliveries') echo "checked"; ?>
                                            ...
                                            <div class="col-md-3"> -->
                                                <div class="custom-control custom-radio" style="display:inline;padding:0 30px">
                                                    <input type="radio" id="more" name="job_type_2"
                                                        <?php if($job->job_type_2=='More Deliveries') echo "checked"; ?>
                                                        value="More
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-12">
                                        <div class="input-group row">
                                            <label for="invalid-state" class="col-sm-4 label_inline"><b>Account
                                                    :</b></label>
                                            <input type="text" readonly required class="form-control col-sm-8" name="account_no"
                                                id="account_no" onblur="account_check()" value="<?= $job->account_no ?>">
                                            <div class="input-group-append">
                                                <button class="input-group-text" data-toggle="modal" data-target="#searchModal"><i class="fa fa-search"></i></button>
                                            </div>
                                        </div>
                                        <br>
                                    </div>
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="input-group row">
                                            <label for="invalid-state" class="col-sm-4 label_inline"><b> Reference No.
                                                    :</b></label>
                                            <input type="text" readonly required class="form-control col-sm-8" name="reference_no"
                                                id="reference_no" onblur="ref_check()" value="<?= $job->reference_no ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-12">
                                        <div class="input-group row">
                                            ...
                                            <input type="text" readonly class="form-control col-sm-8" name="caller_name" value="<?= $job->caller_name ?>"
                                                placeholder="" id="caller_name">
                                            <!-- <div class="input-group-append">
                                                <button class="input-group-text" onclick="caller_search()"><i class="fa fa-search"></i></button>
                                            </div> -->
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="doc" name="commodity"
                                                        <?php if($job->commodity=='document') echo "checked"; ?>
                                            ...
                                            <div class="col-md-4">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="other" name="commodity"
                                                        <?php if($job->commodity=='other') echo "checked"; ?>
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="input-group mb-1 row">
                                            ...
                                            <select name="service_type" id="service_type" class="form-control col-sm-8">
                                                <option value="same day nyc" <?php if($job->service_type=='same day nyc') echo "selected"; ?>>Same Day NYC</option>
                                                <option value="2 hour nyc" <?php if($job->service_type=='2 hour nyc') echo "selected"; ?>>2 Hour NYC</option>
                                                <option value="Messenger" <?php if($job->service_type=='Messenger') echo "selected"; ?>>Messenger</option>
                                                <option value="car" <?php if($job->service_type=='car') echo "selected"; ?>>Car</option>
                                                <option value="mini van" <?php if($job->service_type=='mini van') echo "selected"; ?>>Mini Van</option>
                                                <option value="cargo van" <?php if($job->service_type=='cargo van') echo "selected"; ?>>Cargo Van</option>
                                                <option value="truck 12 ft" <?php if($job->service_type=='truck 12 ft') echo "selected"; ?>>Truck 12 Ft</option>
                                                <option value="truck 18 ft" <?php if($job->service_type=='truck 18 ft') echo "selected"; ?>>Truck 18 Ft</option>
                                                <option value="truck 24 ft" <?php if($job->service_type=='truck 24 ft') echo "selected"; ?>>Truck 24 Ft</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                ...
                                                <input type="text" required class="form-control col-sm-9" name="f_date"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                <label for="invalid-state" class="col-sm-3 label_inline"><b>Pickup Time
                                                        :</b></label>
                                                <input type="text" required class="form-control col-sm-9" name="f_time"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                ...
                                                <input type="text" required class="form-control col-sm-9" id="company_name_s" name="f_name" value="<?= $job->from_name ?>">
                                                <div class="input-group-append">
                                                    <button class="input-group-text" onclick="company_search_shipping('company_name_s')">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                <label for="valid-state" class="col-sm-3 label_inline"><b>Address 1
                                                        :</b></label>
                                                <input type="text" class="form-control col-sm-9" id="address_1_s" name="f_address1" value="<?= $job->from_address1 ?>">
                                                <div class="input-group-append">
                                                    <button class="input-group-text" onclick="company_search_shipping('address_1_s')">
                                                        <i class="fa fa-search"></i>
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                <label for="valid-state" class="col-sm-3 label_inline"><b>Address 2
                                                        :</b></label>
                                                <input type="text" class="form-control col-sm-9" id="address_2_s" name="f_address2" value="<?= $job->from_address2 ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                <label for="invalid-state" class="col-sm-3 label_inline"><b> Room /FL
                                                        No. :</b></label>
                                                <input type="text" name="f_room_no" value="<?= $job->from_room_no ?>" class="form-control col-sm-9" id="room_s">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                ...
                                                <input type="text" required class="form-control col-sm-3" id="city_s" name="f_city" value="<?= $job->from_city ?>">

                                                <label for="invalid-state" class="col-sm-3 label_inline"><b>State :
                                                    </b><span style="color:red">*</span></label>
                                                <input type="text" required class="form-control col-sm-3"  id="state_s" name="f_state" value="<?= $job->from_state ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                <label for="valid-state" class="col-sm-3 label_inline"><b>Zip
                                                        :</b></label>
                                                <input type="text" required class="form-control col-sm-3" id="zip_s" name="f_zip" value="<?= $job->from_zip ?>">

                                                <label for="valid-state" class="col-sm-3 label_inline"><b>Country
                                                        :</b></label>
                                                <input type="text" required class="form-control col-sm-3" name="f_zone" value="<?= $job->from_zone ?>" id="country_s">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                <label for="valid-state" class="col-sm-3 label_inline"><b>Phone
                                                        :</b></label>
                                                <input type="text" required class="form-control col-sm-3" name="f_phone" value="<?= $job->from_phone ?>" id="phone_s">

                                                <label for="valid-state" class="col-sm-3 label_inline"><b>Ext
                                                        :</b></label>
                                                <input type="text" required class="form-control col-sm-3" name="f_ext" value="<?= $job->from_phone_ext ?>" id="ext_s">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                <label for="valid-state" class="col-sm-3 label_inline"><b>Contact Name
                                                        :</b></label>
                                                <input type="address" name="f_contact" value="<?= $job->from_contact_name ?>" class="form-control col-sm-9" id="contact_name_s">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                <label for="valid-state" class="col-sm-3 label_inline"><b>Instruction
                                                        :</b></label>
                                                <textarea class="form-control col-sm-9" name="f_instruction1" id="instruction_s"><?= $job->from_instruction ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                ...
                                                <input type="text" required class="form-control col-sm-9" name="t_date"
                                                    placeholder="" value="<?= $job->to_date ?>">
                                                    <input type="hidden" name="job_edit_id" value="<?= $job->job_edit_id ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                <label for="invalid-state" class="col-sm-3 label_inline"><b>Pickup Time
                                                        :</b></label>
                                                <input type="text" required class="form-control col-sm-9" name="t_time"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                <label for="valid-state" class="col-sm-3 label_inline"><b>Company Name:</b></label>
                                                <input type="text" required class="form-control col-sm-9" id="company_name_c" name="t_name" value="<?= $job->to_name ?>">
                                                <div class="input-group-append">
                                                    <button class="input-group-text" onclick="company_search_consignee('company_name_c')">
                                                        <i class="fa fa-search"></i>
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                <label for="valid-state" class="col-sm-3 label_inline"><b>Address 1
                                                        :</b></label>
                                                <input type="text" class="form-control col-sm-9" id="address_1_c" name="t_address1" value="<?= $job->to_address1 ?>">
                                                <div class="input-group-append">
                                                    <button class="input-group-text" onclick="company_search_consignee('address_1_c')">
                                                        <i class="fa fa-search"></i>
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                <label for="valid-state" class="col-sm-3 label_inline"><b>Address 2
                                                        :</b></label>
                                                <input type="text" class="form-control col-sm-9" id="address_2_c" name="t_address2" value="<?= $job->to_address2 ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                <label for="invalid-state" class="col-sm-3 label_inline"><b> Room /FL
                                                        No. :</b></label>
                                                <input type="text" name="t_room_no" value="<?= $job->to_room_no ?>" class="form-control col-sm-9" id="room_c">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                ...
                                                <input type="text" name="t_city" value="<?= $job->to_city ?>" required class="form-control col-sm-3" id="city_c">

                                                <label for="invalid-state" class="col-sm-3 label_inline"><b>State :
                                                    </b><span style="color:red">*</span></label>
                                                <input type="text" name="t_state" value="<?= $job->to_state ?>" required class="form-control col-sm-3"  id="state_c">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                <label for="valid-state" class="col-sm-3 label_inline"><b>Zip
                                                        :</b></label>
                                                <input type="text" name="t_zip" value="<?= $job->to_zip ?>" required class="form-control col-sm-3" id="zip_c">

                                                <label for="valid-state" class="col-sm-3 label_inline"><b>Country
                                                        :</b></label>
                                                <input type="text" name="t_zone" value="<?= $job->to_zone ?>" required class="form-control col-sm-3" id="country_c">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                <label for="valid-state" class="col-sm-3 label_inline"><b>Phone
                                                        :</b></label>
                                                <input type="text" required name="t_phone" value="<?= $job->to_phone ?>" class="form-control col-sm-3" id="phone_c">

                                                <label for="valid-state" class="col-sm-3 label_inline"><b>Ext
                                                        :</b></label>
                                                <input type="text" name="t_ext" value="<?= $job->to_phone_ext ?>" required class="form-control col-sm-3" id="ext_c">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                                <label for="valid-state" class="col-sm-3 label_inline"><b>Contact Name
                                                        :</b></label>
                                                <input type="address" name="t_contact" value="<?= $job->to_contact_name ?>" class="form-control col-sm-9" id="contact_name_c">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="input-group mb-1 row">
                                ...
                                <div class="row">
                                        ...
                                        <div class="input-group mb-1">
                                            <div class="row">
                                                <div class="col-sm-4 col-6">
                                                    <label for="valid-state" class="label_inline"> Driver Miles
                                                        :</label>
                                                </div>
                                                <div class="col-sm-8 col-6">
                                                    <input type="text" required class="form-control" value="<?= $job->driver_miles ?>" name="driver_miles">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-12">
                                        <div class="input-group mb-1">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8 col-6">
                                                    <input type="text" required class="form-control" value="<?= $job->agent_miles ?>" name="agent_miles">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4 col-12">
                                        <div class="input-group mb-1">
                                            <div class="row">
                                                <div class="col-sm-4 col-6">
                                                    <label for="valid-state" class="label_inline">Company Miles
                                                        :</label>
                                                </div>
                                                <div class="col-sm-8 col-6">
                                                    <input type="text" required class="form-control" value="<?= $job->miles ?>" name="company_miles">
                                                </div>
                                            </div>
                                        </div>
                                    </div>

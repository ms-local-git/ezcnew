      ...
      <div class="app-content content ">
         ...
         <div class="content-wrapper container-xxl p-0">
            ...
            <section name="invoice-printout">
               <div class="row">
                  <div class="col-md-12">
                  <h2 class="content-header-title float-left mb-0">Airport</h2>
                  </div>
               </div><br>
               <div class="row">
                  <div class="col-md-12">
                              ...
                              <div class="col-sm-6 col-12">
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                         <div class="col-sm-3 col-6">
                                           <label for="valid-state">Account Name:<span style="color:red">*</span></label>
                                         </div>
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state">Assigne Airport:</label>
                                       </div>
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state">New Assigne Airport Code:</label>
                                       </div>
                                       <div class="col-sm-9 col-6">

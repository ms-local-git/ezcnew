...
<head>
    ...
    ?>
    <title>Dr Manifest | Browse</title>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card p-2" id="searchBox">
                        <form id="searchForm" action="<?= base_url() ?>/dr_settlement/browse" method="post">
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="settle_date" name="submit_type" <?php if($request->getPost("submit_type")=='settle_date') echo "checked"; ?> value="settle_date" class="custom-control-input" />
                                            <label class="custom-control-label" for="settle_date">Settlement Date</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="card-datatable">
                                    <table class="datatables-basic table display responsive nowrap" style="width:100%">
                                        ...
                                        <tbody id="searchContent">
                                            ...
                                            $pay_amt = floatval($r["settlement_amt"])+floatval($r["bonus"])-floatval($r["deduction"]);
                                            ?>
                                            <tr>
                                                <td><?= $r["code"] ?></td>
												<td><?= $r["first_name"] ?></td>

...
<head>
    ...
    ?>
    <title>Pending Settelments</title>
        ...
        <div class="content-wrapper container-xxl p-0">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Pending Settlement List
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url() ?>/dr_settlement/pending_settlement" method="post">
                            <div class="row">
            ...
            <section id="basic-datatable">
                    <div class="row">
                        ...
                        ?>
                            <div class="card">
                            <h5 class="px-1 pt-1">Driver Code : <?= $r["code"] ?></h5>
							<h5 class="px-1">Driver Name : <?= $r["first_name"] ?></h5>

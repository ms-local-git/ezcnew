...
<head>
    ...
    ?>
    <title>Pending Charges Approval</title>
        ...
        <div class="content-wrapper container-xxl p-0">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Pending Charges Approval
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url() ?>/dr_settlement/pending_charges_approval" method="post">
                            <div class="row">
                                <div class="col-sm-5 col-12">
                                    <div class="form-group">
                                        <label for="invalid-state"><b>Up To Date:<span style="color:red">*</span> </b></label>
                                        <input type="date" class="form-control " name="to_date" placeholder="" value="<?= $request->getPost('to_date') ?>" required />
                                    </div>
                                </div> 
                                <div class="col-sm-5 col-12">
                                    <div class="form-group">
                                        <label for="invalid-state"><b>Driver Code:<span style="color:red">*</span> </b></label>
                                        <input type="text" class="form-control " name="code" placeholder="" value="<?= $request->getPost('code') ?>" required=""/>
                                    </div>
                                </div> 
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 col-12 mt-2">
                                    <div class="form-group">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="greater" name="submit_type" <?php if($request->getPost("submit_type")=='greater') echo "checked"; ?> value="greater" class="custom-control-input" />
            ...
            <section id="basic-datatable">
                    <div class="row">
                        ...
                        ?>
                        <tr class="bg-light">
                            <th colspan="3"><h5 style="font-weight: bolder;">Driver Code : <?= $r["code"] ?></h5></th>
                            <th colspan="4" class="text-right"><h5 style="font-weight: bolder;">Driver Name : <?= $r["first_name"] ?></h5></th>
                        </tr>
                                    <!-- <thead> -->
                                        <tr>
                                            <th>Job No.</th>
                                    ...
                                    <!-- <tbody> -->
                                            <tr>
                                                <td>
                                                    <?= $r["job_no"] ?><BR> 
                                                    Ref: <?= substr($r["reference_no"],0,10) ?><br>
                                                    <?= $r["dr_datetime"] ?>
                                                </td>
                                                <td>
                                                    <b><?= $r["code"] ?></b><BR>
                                                ...
                                                <td>
                                                    <?= $r["from_city"] ?> -- <?= $r["from_zip"] ?>
                                                </td>
                                                <td>
                                                    <?= $r["to_city"] ?> -- <?= $r["to_zip"] ?>
                                                </td>
                                                <td>
                                                    <?php if($r["paper_submitted"]==0) echo "No"; else echo "Yes"; ?>
                                                </td>
                                                <td><?= $r["tolls_parks"] ?></td>
												<td><?= $r["tot"] ?></td>
                                            </tr>

                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Bonus Deduction</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card p-2" id="searchBox">
                            <form id="searchForm" action="<?= base_url() ?>/dr_settlement/bonus_deduction" method="post">
                                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-datatable">
                                ...
                                <form action="<?= base_url() ?>/dr_settlement/bonus_deduction_save" method="post">
                                    ...
                                    <table class="table display responsive nowrap" style="width:100%" id="pickup_table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><strong>Bonus Remarks</th>
                                                <th><strong>Deduction Remarks</th>
                                            </tr>
                                        </thead>
                                        <tbody id="searchContent">
                                            ...
                                            <tr>
                                                <td>
                                                    <?= $r["code"] ?><BR>
                                                    <?= $r["first_name"] ?>
                                                    <input name="sett_id<?= $i ?>" type="hidden" id="sett_id<?= $i ?>" value="<?= $r["id"] ?>"></td>
                                                <td><?= $r["settlement_no"] ?></td>
                                                <td>
                                                    <?= $r["settlement_amt"] ?></td>
                                                    <input name="sett_total<?= $i ?>" type="hidden" id="sett_total<?= $i ?>" value="<?= $r["settlement_amt"] ?>">
                                                <td>
                                                    <input name="ded<?= $i ?>" type="number" step="any" id="ded<?= $i ?>"  value="<?= $r["deduction"] ?>" class="form-control">
                                                </td>
                                                <td>
                                                    <input name="bonus<?= $i ?>" type="number" step="any" id="bonus<?= $i ?>" value="<?= $r["bonus"] ?>"  class="form-control" >
                                                </td>
                                                <td>
                                                    <input name="total<?= $i ?>" type="number" step="any" id="total<?= $i ?>" value="<?= $r["total"] ?>" readonly class="form-control" value="<?= $r["settlement_amt"] ?>">
                                                </td>
                                                <td>
                                                    <input name="bon_remarks<?= $i ?>" type="number" step="any"  value="<?= $r["bon_remarks"] ?>" id="bon_remarks<?= $i ?>" class="form-control">
                                                </td>
                                                <td>
                                                    <input name="ded_remarks<?= $i ?>" type="number" step="any"  value="<?= $r["ded_remarks"] ?>" id="ded_remarks<?= $i ?>" class="form-control">
                                                </td>			
                                            </tr>
                                            <?php $i++; } ?>
                                        </tbody>

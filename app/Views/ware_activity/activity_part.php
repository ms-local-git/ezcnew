...
<head>
    ...
    ?>
    <title>Warehouse Activity By Part</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url() ?>/ware_activity/activity_part" method="post">
                            <div class="row">
                                <div class="col-sm-5 col-12">
                                    <div class="form-group">
                                        <label for="invalid-state"><b>Account No: </b><span style="color:red">*</span></label>
                                        <input type="text" class="form-control " name="account_no" placeholder="" value="<?= $request->getPost('account_no') ?>" required />
                                    </div>
                                </div> 
                                <div class="col-sm-5 col-12">
                                    <div class="form-group">
                                        <label for="invalid-state"><b>Part No : </b></label>
                                        <input type="text" class="form-control " name="part_no" placeholder="" value="<?= $request->getPost('part_no') ?>" />
                                    </div>
                                </div> 

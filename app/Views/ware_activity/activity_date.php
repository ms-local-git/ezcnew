...
<head>
    ...
    ?>
    <title>Warehouse Activity By Date</title>
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Date
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url() ?>/ware_activity/activity_date" method="post">
                            <div class="row">
                                ...
                                <div class="col-sm-5 col-12">
                                    <div class="form-group">
                                        <label for="invalid-state"><b>To Date: </b><span style="color:red">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-sm-5 col-12">
                                    <div class="form-group">
                                        <label for="invalid-state"><b>Account No:<span style="color:red">*</span> </b></label>
                    ...
                    <div class="row">
                        ...
                        ?>
                                        <tr>
                                            ...
                                            <td><?= $r['trans_type'] ?></td>
                                            <td>
                                                <?= h_gldate($r['date1']) ?> <?= h_gtime($r['time1']) ?>
                                            </td>
                                        </tr>
                                    </tbody>

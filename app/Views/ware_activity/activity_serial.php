...
<head>
    ...
    ?>
    <title>Warehouse Activity By Serial</title>
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Warehouse Activity</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                   
                                    <li class="breadcrumb-item active">Serial No.
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url() ?>/ware_activity/activity_serial" method="post">
                            <div class="row">
                                <div class="col-sm-5 col-12">
                                    <div class="form-group">
                                        <label for="invalid-state"><b>Account No:</b><span style="color:red">*</style> </label>
                                        <input type="text" class="form-control " name="account_no"  value="  <?= $request->getPost('account_no') ?>" required />
                                    </div>
                                </div> 
                                <div class="col-sm-5 col-12">
                                    <div class="form-group">
                                        <label for="invalid-state"><b>Serial No: </b></label>
                                        <input type="text" class="form-control " name="serial_no" placeholder="" value="<?= $request->getPost('serial_no') ?>" />
                                    </div>
                                </div> 

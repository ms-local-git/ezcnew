    ...
    <div class="app-content content ">
         ...
         <div class="content-wrapper container-xxl p-0">
            ...
            <section name="invoice-printout">
               <div class="row">
                  <div class="col-md-12">
                  <h2 class="content-header-title float-left mb-0">Resend SMS:</h2>
                  </div>
               </div><br>
               <div class="row">
                  <div class="col-md-12">
                     <div class="card">
                        <div class="card-header">
                           <div>
                              <h4 class="card-title">Jobs-Resend SMS:</h4>
                              <br/>
                           </div>
                        </div>
                        <div class="card-body">
                           ...
                           <div class="card-body">
                              ...
                              <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       ...
                                       <label for="valid-state">Jobs#:</label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                                       <span style="color:red">210101014</span>
                                        </div>
                                        </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                         <div class="col-sm-3 col-6">
                                           <label for="valid-state">Refference#:</label>
                                         </div>
                                         <div class="col-sm-9 col-6">
                                       <span style="color:red">8698691</span>
                                        </div>
                                        </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state">Caller:<span style="color:red">*</span></label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state">Client Account:</label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                                       <span style="color:red">7016(dhl sameday)</span>
                                        </div>
                                        </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-sm-6 col-12">
                                    ...
                                    <div class="row">
                                     <div class="col-sm-3 col-6">
                                       ...
                                       <div class="col-sm-9 col-6">
                                       <label class="form-check-label"><span style="color:red"><h4>408(AHMED)</h4></span></label>
                                        </div>
                                 </div>
                                  <div class="col-sm-6"></div><br>

                                  <div class="col-sm-12 text-center">
                                    <button class="btn btn-primary w-100" type="submit" >Send SMS & Close</button>
                                  </div>
                              </div>

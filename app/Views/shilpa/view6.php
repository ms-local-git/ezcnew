...
<html class="loading" lang="en" data-textdirection="ltr">
   ...
   <head>
      <?php
         ...
         ?>
      <title>Agents-Charges Manage</title>
      ...
      <div class="app-content content ">
         ...
         <div class="content-wrapper container-xxl p-0">
            ...
            <section name="invoice-printout">
               <div class="row">
                  <div class="col-md-12">
                  <h2 class="content-header-title float-left mb-0">Agents-Charges Manage</h2>
                  </div>
               </div><br>
               <div class="row">
                  <div class="col-md-12">
                  <div class="card">
                        <div class="card-header">
                           <div>
                              <h4 class="card-title">Agent Price Chart:</h4>
                              <br/>
                           </div>
                        </div>
                     <div class="card-body">
                       ...
                       <div class="row">
                          <div class="col-sm-12">
                             <div class="card">
                               ...
                               <tbody>
                               <tr><b>Agent Price Chart</b></tr>
                               <tr>
                              <th scope="row">Job No.:</th>
                               <td><span style="color:purple">210101009</span></td>
                               <td>Refference No.:<span style="color:purple"> J4O0019221</span></td>
                                ...
                                <td><input type="text" class="form-control"></td>
                                 ...
                                 <tr>
                                <th scope="row">Agent No.:<span style="color:purple">A720 NITE & DAY LOGISTICS</span></th>
                                <td>Total Charges:<span style="color:purple"> 75.10</span><br></td>
                                <td><button type="button" claass="form-control">modify</button></td>
                           
                                 </tr>
                                <tr>
                                <th scope="row"><b>Total Agent Chrges:<span style="color:purple">75.10</span></b></th>
                               ...
                               <div class="col-sm-6 col-12">
                                ...
                                <div class="col-sm-6 col-12">
                                 <div class="form-group">
                                     <div class="row">
                                      <div class="col-sm-6 col-6">
                                       <label for="valid-state">Department:
                                       </label>
                                       </div> 
                                       <div class="col-sm-6 col-6">
                                       <input type="text" class="form-control" placeholder="">
                                ...
                                <div class="col-sm-6 col-12">
                                 <div class="form-group">
                                     <div class="row">
                                      <div class="col-sm-6 col-6">
                                       <label for="valid-state">Agent Charges:
                                       </label>
                                       </div> 
                                       <div class="col-sm-6 col-6">
                                       <input type="text" class="form-control" placeholder="">
                                 ...
                                 <div class="form-group">
                                     <div class="row">
                                      <div class="col-sm-3 col-6">
                                       <label for="valid-state">
                                           Notes:
                                       </label>
                                       </div> 
                                       <div class="col-sm-9 col-6">
                                       <textarea class="form-control rounded-0" id="FormControlTextarea1" rows="4">
                                ...
                                <center> <div class="col-sm-4 text-center">
                                   <button class="btn btn-primary w-100" type="submit" >save & close</button>
                                </div> 
                                </center>
                            </div>
                        </div>

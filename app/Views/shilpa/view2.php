                        ...
                        <div class="card-body">
                           ...
                           <div class="row">
                               <div class="col-sm-2 col-12">
                                 <label for="valid-state">Current Folder:</label>
                                 
                                </div>
                                <div class="col-sm-4 col-12"></div>
                                
                                <div class="col-sm-2 col-12">
                                <button type="submit"><i class="fa fa-search"></i>Create CPT</button>
                                </div><br>
                                <div class="col-sm-2 col-12">
                                <button type="submit"><i class="fa fa-search"></i>Create CPT Dir.
                                </button></div><br>
                                <div class="col-sm-2 col-12">
                                <button type="submit"><i class="fa fa-search"></i>Open CPT Dir.
                                </button></div><br>
                            </div> <br>  
                            </div>    
                        </form>

   ...
   <body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
      ...
      <div class="app-content content ">
         ...
         <div class="content-wrapper container-xxl p-0">
            ...
            <div>
                                 <h2 class="card-title">Client Price Table</h2>
                                 <br>
            </div> 
               <div class="row">
                  <div class="col-md-12">
                     <div class="card">
                        <div class="card-header">
                           ...
                           <div>
                              <h6 class="card-title"><h3>Client Price Table</h3></h6>
                              <br/>
                           </div>
                        </div>
                        <div class="card-body">
                           ...
                           <div class="row">
                               <div class="col-sm-3 col-12">
                                 <label for="valid-state">Select CPT Directory:</label>
                                 <button type="submit"><i class="fa fa-search"></i>Search</button>
                                </div><br>
                                <div class="col-sm-5 col-12"></div>
                                
                                <div class="col-sm-2 col-12">
                                <button type="submit"><i class="fa fa-search"></i>Create Directory</button></div><br>
                                <div class="col-sm-2 col-12">
                                <button type="submit"><i class="fa fa-search"></i>Modify Directory</button></div><br>
                            </div> <br>   
                        </form>
                        <div class="row">
                            <div class="col-sm-2">
                                <img src="img1.png" height="50" width="50">1
                            </div>
                           <div class="col-sm-2">
                            <img src="img1.png" height="50" width="50">1

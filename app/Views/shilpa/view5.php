                              ...
                              <div class="row">
                                    ...
                                    <div class="form-group">
                                       <div class="row">
                                         <div class="col-sm-3 col-6">
                                           <label for="valid-state">Email Id:<span style="color:red">*</span> </label>
                                         </div> 
                                          <div class="col-sm-6 col-12"> 
                                           <select name="mail" id="mail" required>
                                           <option value="" selected="selected">Select mail</option>
                                           <option value="" selected="selected">Select mail</option>
                                           <option value="" selected="selected">Select mail</option>
                                           <option value="" selected="selected">Select mail</option>
                                  ...
                                  <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                         <div class="col-sm-3 col-6">
                                           <label for="valid-state">Message: </label>
                                         </div>
                                         
                                         <div class="form-group">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="a" name="job" checked value="not" class="custom-control-input"  />
                                                    <label class="custom-control-label" for="not">Delievery Attempt</label>
                                                </div>
                                            </div>
                                       ...
                                       <div class="row">
                                         ...
                                         <div class="form-group">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="b" name="job" checked value="not" class="custom-control-input"  />
                                                    <label class="custom-control-label" for="not">Driver Waiting Dilevery</label>
                                                </div>
                                            </div>
                                          <div class="col-sm-6"></div>
                                       </div>
                                       <div class="row">
                                         ...
                                         <div class="form-group">
                                                <div class="custom-control custom-radio">
                                                    ...
                                                    <label class="custom-control-label" for="not">No show at airport</label>
                                                </div>
                                            </div>
                                          <div class="col-sm-6"></div>
                                       </div>
                                       <div class="row">
                                         ...
                                         <div class="form-group">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="d" name="job" checked value="not" class="custom-control-input"  />
                                                    <label class="custom-control-label" for="not">Ray Test</label>
                                                </div>
                                            </div>
                                          <div class="col-sm-6"></div>
                                       </div>
                                       <div class="row">
                                         ...
                                         <div class="form-group">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="e" name="job" checked value="not" class="custom-control-input"  />
                                                    <label class="custom-control-label" for="not">Test</label>
                                                </div>
                                            </div>
                                          <div class="col-sm-6"></div>
                                       </div>
                                       <div class="row">
                                         ...
                                         <div class="form-group">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="f" name="job" checked value="not" class="custom-control-input"  />
                                                    <label class="custom-control-label" for="not">Waiting at airport</label>
                                                </div>
                                            </div>
                                          <div class="col-sm-6"></div>
                                       </div>
                                       <div class="row">
                                         ...
                                         <div class="form-group">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="g" name="job" checked value="not" class="custom-control-input"  />
                                                    <label class="custom-control-label" for="not">Waiting at pickup</label>
                                                </div>
                                            </div>
                                          <div class="col-sm-6"></div>
                                       </div>
                                       <div class="row">
                                         ...
                                         <div class="form-group">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="h" name="job" checked value="not" class="custom-control-input"  />
                                                    <label class="custom-control-label" for="not">Custom message</label>
                                                </div>
                                            </div>
                                          <div class="col-sm-6"></div>
                                       </div>

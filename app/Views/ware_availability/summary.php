                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Inventory Summary
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url() ?>/ware_availability/summary" method="post">
                            <div class="row">
                                <div class="col-sm-2 col-12">
                                    <div class="form-group">
                                        <label for="invalid-state" style="padding-top: 9px;"><b>Account Number:<span style="color:red">*</span> </b></label>
                                    </div>
                                </div> 

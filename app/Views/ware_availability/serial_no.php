            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url() ?>/ware_availability/serial_no" method="post">
                            <div class="row">
                                <div class="col-sm-5 col-12">
                                    <div class="form-group">
                                        <label for="invalid-state"><b>Account No:</b><span style="color:red">*</span></label>
                                        <input type="text" required class="form-control " name="account_no" placeholder="" value="<?= $request->getPost('account_no') ?>" required />
                                    </div>
                                </div> 
                                <div class="col-sm-5 col-12">
                                    <div class="form-group">
                                        <label for="invalid-state"><b>Serial No:</b><span style="color:red">*</span></label>
                                        <input type="text" required class="form-control " name="serial_no" placeholder="" value="<?= $request->getPost('serial_no') ?>" required/>
                                    </div>
                                </div> 

                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Inventory Detailed
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url() ?>/ware_availability/detailed_info" method="post">
                            <div class="row">
                                <div class="col-sm-2 col-12">
                                    <div class="form-group">
                                        <label for="invalid-state" style="padding-top: 9px;"><b>Account Number: </b><span style="color:red">*</span></label>
                                    </div>
                                </div> 
                    ...
                    <div class="row">
                        ...
                        ?>
                                        <tr>
                                            ...
                                            <td><?= $r['tracking_no'] ?></td>
                                            <td><?= $r['weight'] ?></td>
                                            <td><a href="<?= base_url() ?>/ware_availability/info_modify?id=<?= $r['id'] ?>">Edit</a></td>
                                        </tr>
                                    <?php } } ?>
                                    </tbody>

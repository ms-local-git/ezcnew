                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Part No.
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url() ?>/ware_availability/part_no" method="post">
                            <div class="row">
                                ...
                                <div class="col-sm-5 col-12">
                                    <div class="form-group">
                                        <label for="invalid-state"><b>Part No:</b><span style="color:red">*</span></label>
                                        <input type="text" required class="form-control " name="part_no" placeholder="" value="<?= $request->getPost('part_no') ?>" required />
                                    </div>
                                </div> 

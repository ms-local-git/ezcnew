...
<head>
    ...
    ?>
    <title>Warehouse Availability Search</title>
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Availability Search
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url() ?>/ware_availability/availability_search" method="post">
                            <div class="row">
                                <div class="col-sm-2 col-12">
                                    <div class="form-group">
                                        <label for="invalid-state" style="padding-top: 9px;"><b>Search:</b></label>
                                    </div>
                                </div> 
                                <div class="col-sm-8 col-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control " name="account_no" placeholder="" value="<?= $request->getPost('account_no') ?>" />
                                    </div>
                                </div> 
                                <div class="col-sm-2 col-12">
                                    <div class="form-group">
            ...
            <section id="basic-datatable">
                    <div class="row">
                        ...
                        <?php 
                            ...
                            if(($r['is_found'])==1){$is_found='Yes';}else{$is_found='No';}
                        ?>
                                        <tr>
                                            <td><?= $r['account_no'] ?></td>
                                            <td><?= $r['part_no'] ?></td>
                                            ...
                                            <td><?= $is_found ?></td>
                                            <td><?= $r['entered_by'] ?></td>
                                            <td><?= $r['entered_date'] ?></td>
                                            <td><?= $r['last_updated_by'] ?></td>
                                            <td><a href="<?= base_url() ?>/ware_availability/availability_modify?id=<?= $r['id'] ?>">Edit</a></td>
                                        </tr>
                                    <?php } } ?>
                                    </tbody>

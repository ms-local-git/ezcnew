      ...
      <div class="app-content content ">
         ...
         <div class="content-wrapper container-xxl p-0">
            ...
            <section name="invoice-printout">
               <div class="row">
                  <div class="col-md-12">
                     <div class="card-title"><h4>Add New Vehicle</h4></div>
                     <div class="card">
                        <div class="card-header">
                           <div>
                              <h6 class="card-title">New Vehicle:</h6>
                              <br/>
                           </div>
                        </div>
                        <div class="card-body">
                           <form action="<?= base_url() ?>/Vehicle/create" method="POST" enctype="multipart/form-data">
                           <div class="row">
                              <div class="col-sm-6 col-12">
                                 <div class="form-group">
                                    <label for="valid-state"><b>VIN: </b><span style="color:red">*</span></label>
                                    <input type="text" class="form-control " name="vin" placeholder=" " value="" required />
                                 </div>
                              </div>
                              <div class="col-sm-6 col-12">
                                 <div class="form-group">
                                    <label for="valid-state"><b>Plate: </b></label>
                                    <input type="text" class="form-control " name="plate" placeholder=" " value="" required />
                                 </div>
                              </div>
                              <div class="col-sm-6 col-12">
                                 <div class="form-group">
                              ...
                              <div class="col-sm-6 col-12">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control " name="purchase_date" placeholder="" value="">
                                 </div>
                              </div>
                              <div class="col-sm-6 col-12">
                                 <div class="form-group">
                                    <label for="valid-state"><b>Make: </b> <span style="color:red">*</span></label>
                                    <input type="text" class="form-control " name="make" placeholder="" value="" required />
                                 </div>
                              </div>
                              <div class="col-sm-6 col-12">
                                 <div class="form-group">
                                    <label for="invalid-state"><b>Model:</b> <span style="color:red">*</span></label>
                                    <input type="text" class="form-control " name="model" placeholder="" value="" required />
                                 </div>
                              </div>
                              <div class="col-sm-6 col-12">
                                 <div class="form-group">
                                    <label for="valid-state"><b>Year#:</b> </label>
                                    <input type="text" class="form-control " name="year" placeholder="" value=""  />
                                 </div>
                              </div>
                              <div class="col-sm-6 col-12">
                                 <div class="form-group">
                                    <label for="invalid-state"><b>Usable Weight:</b></label>
                                    <input type="text" class="form-control " name="usable_weight" placeholder="" value="" />
                                 </div>
                              </div>
                              <div class="col-sm-6 col-12">
                                 <div class="form-group">
                              ...
                              <div class="col-sm-6 col-12">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control " name="gw" placeholder="" value="" />
                                 </div>
                              </div>
                              <div class="col-sm-6 col-12">
                                 <div class="form-group">
                              ...
                              <div class="col-sm-6 col-12">
                                 <div class="form-group">
                                    ...
                                    <input type="date" class="form-control " name="hut" placeholder="" value="" />
                                 </div>
                              </div>
                              <div class="col-sm-6 col-12">
                                 <div class="form-group">
                              ...
                              <div class="col-sm-6 col-12">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control " name="insurance" placeholder="" value="" />
                                 </div>
                              </div>
                              <div class="col-sm-6 col-12">
                                 <div class="form-group">
                                    <label for="invalid-state"><b>Sold Date:</b> </label>
                                    <input type="date" class="form-control " name="sold_date" placeholder="" value="" />
                                 </div>
                              </div>
                              <div class="col-sm-12 col-12">
                                 <div class="form-group">
                                    <label for="invalid-state"><b>Depriciation:</b> </label>
                                    <textarea class="form-control" name="depriciation" rows="3" placeholder="type here..."></textarea>
                                 </div>
                              </div>
                              <div class="col-sm-6 col-12">
                                 <div class="form-group">

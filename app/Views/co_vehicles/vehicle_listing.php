                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Vehicles Listing
                                    </li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <table class="datatables-basic table display responsive nowrap" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= date("m/d/Y", strtotime($v['assign_datetime'])) ?></td>

                                            <td  >
                                                <a href="<?= base_url() ?>/co_vehicles/edit_listing?id=<?= $v['id'] ?>" class="btn-sm btn-primary">Edit</a>
                                                <a href="<?= base_url() ?>/co_vehicles/vehicle_history?id=<?= $v['id'] ?>" class="btn-sm btn-primary">Vehicle History</a>
                                                <a href="<?= base_url() ?>/co_vehicles/assign_history?id=<?= $v['id'] ?>" class="btn-sm btn-primary">Assign History</a>
                                                <a href="<?= base_url() ?>/co_vehicles/report?id=<?= $v['id'] ?>" class="btn-sm btn-primary">Report</a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>

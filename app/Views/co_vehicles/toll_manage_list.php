...
<head>
    ...
    ?>
    <title>Toll Manage Listing</title>
                                ...
                                <table class="datatables-basic table display responsive nowrap" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $t["agency"] ?></td>
                                            <td>
										        <a href="<?= base_url() ?>/co_vehicles/edit_tolls?id=<?= $t['id'] ?>" class="btn btn-primary">Edit</a>
                                                <a href="<?= base_url() ?>/co_vehicles/tolls_delete?id=<?= $t['id'] ?>" class="btn btn-primary">Delete</a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>

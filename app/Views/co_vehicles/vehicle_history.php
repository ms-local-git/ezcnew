                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Vehicle History
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card p-2">
                        <div class="row">
                            <div class="col-md-4">
                                <p><strong>Vehicle Name: <?= $vehicle->type ?></strong></p>
                            </div>
                            <div class="col-md-4">
                                <p><strong>Plate : <?= $vehicle->plate ?></strong></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <p><strong>Model : <?= $vehicle->model ?></strong></p>
                            </div>
                            <div class="col-md-4">
                                <p><strong>Color : <?= $vehicle->color ?></strong></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-datatable">
                                <table class="table minData_table">
                                    <thead>
                                        <tr>
                                            <th>S.No.</th>
                                            <th>Field Name</th>
                                    ...
                                    <tbody>
                                        ...
                                        <td><?= $h["new_value"];?></td>
                                        <td><?= $h["entry_by"];?></td>
                                        <td><?= date("m/d/Y", strtotime($h['date_time'])); ?></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>

...
<head>
    ...
    ?>
    <title>Missing Settlement</title>
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Performance Report
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url() ?>/dr_new_stuff/missing_settlement" method="post">
                            <div class="row">
                                <div class="col-sm-5 col-12">
                                    <div class="form-group">
                                    <label for="invalid-state"><b>From Driver:<span style="color:red">*</span> </b></label>
                                    <input type="text" class="form-control " name="from_driver" placeholder="" value="<?= $request->getPost('from_driver') ?>"  required=""/>
                                    </div>
                                </div> 
                                <div class="col-sm-5 col-12">
                                    <div class="form-group">
                                    <label for="invalid-state"><b>To Driver:<span style="color:red">*</span></b></label>
                                    <input type="text" class="form-control " name="to_driver" placeholder="" value="<?= $request->getPost('to_driver') ?>" required=""/>
                                    </div>
                                </div> 
                            ...
                            <div class="card">
                                ...
                                <?php $driver=0;
                                 foreach ($reports as $r) {
                                    if($driver!=$r['code']) { $n=1; ?>
                                    <tr class="bg-light">
                                        <th colspan="3"><h4>Driver Code : <?= $r['code'] ?></h4></th>
                                        <th colspan="3"><h4 class="text-right">Name : <?= $r['first_name'] ?> <?= $r['last_name'] ?></h4></th>
                                    </tr>
                                                    <tr>
                                                        <th>Sl No.</th>
                                                        <th>Job No.</th>
                                       ...
                                       <tr>
                                            <td><?= $n ?></td>
                                            <td><?= $r["job_no"] ?></td>
                                            <td><?= h_gdate($r["driver1_date"]) ?></td>														  
                                            <td><?= $r["from_name"] ?><BR><?= $r["from_zip"] ?></td>									  
                                            <td><?= $r["to_name"] ?><BR><?= $r["to_zip"] ?></td>
                                            <td>$<?= get_charges($r["driver_id1"],$r["id"]) ?></td>
                                       </tr>
                                <?php $n++; }  ?>
                                </table>
                                <?php } ?>

                  ...
                  <div class="col-md-12">
                     <div class="card">
                        <div class="card-header">
                           <div>
                              <h6 class="card-title">New Branc ::</h6>
                              <br/>
                           </div>
                        </div>
                        <div class="card-body">
                           <form action="<?= base_url() ?>/Branch/update" method="POST" enctype="multipart/form-data">
                           <div class="row">
                     <div class="col-md-12">
                        <div class="card">
                           <div class="card-header">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       ...
                                       <label for="valid-state">Branch Name :</label>
                                       </div>
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state">Phone 1 :</label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state">Address 1 :</label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state">Fax 1 :</label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                                       <input type="text" class="form-control" name="fax1" value="<?= $row['fax1'] ?>">
                                      </div>
                                        </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state">ZIP :</label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-9 col-6">
                                       <input type="text" class="form-control" name="fax2" value="<?= $row['fax2'] ?>">
                                      </div>
                                        </div>
                                    </div>
                                 </div>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state">Billing Contact Name :</label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                                       <input type="text" class="form-control" name="b_contact_name" value="<?= $row['b_contact_name'] ?>">
                                      </div>
                                        </div>
                                    </div>
                                 </div>
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state">Billing Contact Phone :</label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                                       <input type="text" class="form-control" name="b_contact_phone" value="<?= $row['b_contact_phone'] ?>">
                                      </div>
                                        </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-9 col-6">
                                       <input type="text" class="form-control" name="b_contact_email" value="<?= $row['b_contact_email'] ?>">
                                      </div>
                                        </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="ain_ss_no" value="<?= $row['ain_ss_no'] ?>">
                                      </div>
                                      <div class="col-sm-3 col-6">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-9 col-6">
                                       <input type="text" class="form-control" name="night_phone" value="<?= $row['night_phone'] ?>">
                                      </div>
                                        </div>
                                    </div>
                                 </div>
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-9 col-6">
                                       <input type="text" class="form-control" name="night_fax" value="<?= $row['night_fax'] ?>">
                                      </div>
                                        </div>
                                    </div>
                                 </div>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state">City Name  :</label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                                       <input type="text" class="form-control" name="serving_city"value="<?= $row['serving_city'] ?>">
                                      </div>
                                        </div>
                                    </div>
                                 </div>
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-9 col-6">
                                       <input type="text" class="form-control" name="serving_airport" value="<?= $row['serving_airport'] ?>">
                                      </div>
                                        </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       <div class="row">
                                        <div class="col-sm-3 col-6">
                                       <label for="valid-state">ZIP Code :</label>
                                       </div>
                                       <div class="col-sm-9 col-6">
                                       <input type="text" class="form-control" name="serving_zip" value="<?= $row['serving_zip'] ?>">
                                      </div>
                                        </div>
                                    </div>
                                 </div>

            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Branch Listing</h2>
                                ...
                                <table class="datatables-basic table">
                                    ...
                                    <tbody id="searchContent">
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $r['phone1'] ?></td>
                                            <td><?= $r['fax1'] ?></td>
                                            <td><a href="branch/edit/<?= $r['id'] ?>"><button type="button" class="btn btn-primary btn-sm">Edit</button></a></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>

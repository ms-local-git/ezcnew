...
<head>
    ...
    ?>
    <title>Dr Manifest | Manifest Submitted</title>
        ...
        <div class="content-wrapper container-xxl p-0">
            <div class="content-header row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Manifest Submitted
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card p-2">
                            <form id="searchForm" action="<?= base_url() ?>/dr_manifest/manifest_submitted" method="post">
                                <div class="row">
                                    <label class="col-md-2"><h3>Driver Code:<span style="color:red">*</span></h3></label>
                                    <input type="text" name="search" class="col-md-8 form-control" required="">
                                    <div class="col-md-2">
                    ...
                    <div class="col-12">
                        ...
                        <?php if(isset($reports)) { ?>
                            <div class="card-datatable pb-3">
                                <form action="<?= base_url() ?>/dr_manifest/manifest_submitted_save" method="post">
                                    <input type="hidden" name="manifest_count" value="<?= count($reports) ?>">
                                    <table class="table" id="pickup_table">
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th></th>
                                        ...
                                        <tbody id="searchContent">
                                            ...
                                            <tr>
                                                <td>
                                                    Date: <?= h_gdate($r["manifest_date"]) ?>
                                                    <input type="hidden"  name="dr_manifest_id<?= $i ?>" value="<?= $r['id'] ?>">
                                                </td>
                                                <td>
                                                    <div class="custom-control custom-checkbox">
                                                        Manifest Submitted 
                                                        <input type="checkbox" class="custom-control-input" name="dr_manifest_submit<?= $i ?>" value="1" id="colorCheck<?= $i ?>">
                                                        <label class="custom-control-label" for="colorCheck<?= $i ?>">
                                                            <input name="dr_manifest_text<?= $i ?>" type="text" class="form-control">
                                                        </label>
                                                    </div>
                                                </td>
                                            </tr>
...
$(document).ready(function(){
	<?php if(isset($_SESSION['msg'])) { ?>
        alert('<?= $_SESSION['msg'] ?>');
        Swal('success','<?= $_SESSION['msg'] ?>','Success');
    <?php } ?>

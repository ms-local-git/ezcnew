...
<head>
    ...
    ?>
    <title>Manifest submit report</title>
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Manifest Submit Report
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url() ?>/dr_manifest/manifest_submit_report" method="post">
                            <div class="row">
                                ...
                                <div class="col-sm-5 col-12 mt-2">
                                    <div class="form-group">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="all" name="submit_type" checked value="0" class="custom-control-input"  />
                                            <label class="custom-control-label" for="all">Not Submitted</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-5 col-12 mt-2">
                                    <div class="form-group">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="greater" name="submit_type" <?php if($request->getPost("submit_type")=='1') echo "checked"; ?> value="1" class="custom-control-input" />
                                            <label class="custom-control-label" for="greater">Submitted</label>
                                        </div>
                                    </div>
                                </div>
                            </div>   
                                    ...
                                    <tbody id="searchContent">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= h_gdate($r["manifest_date"]) ?> <?= $r["notes"] ?></td>
                                                <td><?= $r["user_id"] ?> <?= h_gdate($r["user_date_time"]) ?></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>

    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Warehouse Modify</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">

                                    <li class="breadcrumb-item active">Modify Tracking
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card p-2">
                        <form action="<?= base_url() ?>/ware_modify/tracking_modify" method="post" id="serial_check">
                            <div class="row">
                                <label class="col-md-2" style="padding-top: 9px;">Serail No.</label>
                                <input type="text" name="serial_no" required value="<?= $request->getPost('serial_no') ?>"
                                    class="form-control col-md-4" onblur="serial_check()">
                        ...
                        <br>
                        <form action="<?= base_url() ?>/ware_modify/tracking_update" method="post">

                            <?php if(isset($inventory)) { ?>
                            <div class="row" id="serial_info">
                                <div class="col-md-6">
                                    <label>Under Client</label>
                                    <input type="text" disabled class="form-control"
                                        value="[<?=$inventory->account_no?>] &nbsp;- &nbsp;<?=$inventory->name?>">
                                    <input type="hidden" name="serial_no" required value="<?= $request->getPost('serial_no') ?>">
                                </div>
                                <div class="col-md-6">
                                    <label>Tracking No.</label>
                                    <input type="text" disabled class="form-control"
                                        value="<?= $inventory->tracking_no ?>">
                                </div>
                                <div class="col-md-6">
                                    <label>Part No.</label>
                                    <input type="text" disabled class="form-control" value="<?= $inventory->part_no ?>">
                                </div>
                                <div class="col-md-6">
                                    <label>Part Location</label>
                                    <input type="text" disabled class="form-control"
                                        value="<?= $inventory->part_loc ?>">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <label>Serial Location</label>
                                    <input type="text" disabled class="form-control"
                                        value="<?= $inventory->serial_loc ?>">
                                </div>
                                <div class="col-md-6">
                                    <label>Weight</label>
                                    <input type="text" disabled class="form-control" value="<?= $inventory->weight ?>">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <label class="col-md-2" style="padding-top: 9px;">New Tracking No.</label>
                                <input type="text" name="tracking_no" value="<?= $inventory->tracking_no ?>" required class="form-control col-md-4">
                            </div>
                            <div>
                                <br>

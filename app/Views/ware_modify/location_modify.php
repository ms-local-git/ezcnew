    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Modify Serial Location
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card p-2">
                        <form action="<?= base_url() ?>/ware_modify/location_modify" method="post" id="serial_check">
                            <div class="row">
                        ...
                        <br>
                        <form action="<?= base_url() ?>/ware_modify/location_update" method="post">
                            ...
                            <br>
                            <div class="row">
                                <label class="col-md-2" style="padding-top: 9px;">New Serial Location</label>
                                <input type="text" name="serial_loc" value="<?= $inventory->serial_loc ?>" required class="form-control col-md-4">
                            </div>
                            <div>
                                <br>

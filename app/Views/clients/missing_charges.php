...
<head>
    ...
    ?>
    <title>Missing Clients charges</title>
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Missing Client Charges</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                   
                                    <li class="breadcrumb-item active">Missing Client Charges Reporting
                                    </li>
                                </ol>
                            </div>
                        </div>
          ...
          <section id="invoice-printout">
              <div class="row">
                  <div class="col-md-12">
                      <div class="card">
                          <div class="card-body">
                              <form action="<?= base_url() ?>/clients/missing_charges" method="post">
                                  <div class="row">
                                      <label class="col-md-2">
                                          <h5>To Date:<span style="color:red">*</span> </h5>
                                      </label>
                                      <input type="date" class="form-control col-md-8" name="to_date"
                                          value="<?= $request->getPost('to_date') ?>" required="" />
                                      <div class="col-md-2">
                                      ...
                                      <div class="col-md-6">
                                          <div class="custom-control custom-checkbox">
                                              <input type="checkbox" class="custom-control-input"
                                                  <?php if($request->getPost("dr_charges")=='1') echo "checked"; ?>
                                                  id="colorCheck1" name="dr_charges" value="1">
                                              <label class="custom-control-label" for="colorCheck1"> Without Driver Missing Charges</label>
                                          </div>
                                      </div>
                                  </div>
                              </form>

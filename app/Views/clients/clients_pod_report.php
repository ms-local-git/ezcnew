            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Clients POD</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                   
                                    <li class="breadcrumb-item active">Clients POD Report
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card px-3 py-2" id="searchBox">
                            <form id="searchForm" action="<?= base_url() ?>/clients/clients_pod_report" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 col-12">
                                        ...
                                        <input type="number" class="form-control" name="client" placeholder="" value="<?= $request->getPost('client') ?>" />
                                        </div>
                                    </div> 
                                </div>        

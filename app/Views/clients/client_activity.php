            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Clients Activity</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                   
                                    <li class="breadcrumb-item active">Clients Activity Listing
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card px-3 py-2" id="searchBox">
                            <form id="searchForm" action="<?= base_url() ?>/clients/client_activity_search" method="post">
                                <div class="row">
                                ...
                                <div class="col-sm-5 col-12">
                                        ...
                                        <input type="number" class="form-control" name="days" placeholder="" value="<?= $request->getPost('days') ?>" />
                                        </div>
                                    </div> 
                                    <div class="col-md-5">
                                        <!-- <div class="col-sm-3 col-12 mt-2"> -->
                                            <div class="form-group">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="not" name="job" checked value="not" class="custom-control-input"  />
                                                    <label class="custom-control-label" for="not">Jobs Not coming from last</label>
                                                </div>
                                            </div>
                                        <!-- </div> -->
                                        <div class="form-group">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="job" name="job" <?php if($request->getPost("job")=='job') echo "checked"; ?> value="job" class="custom-control-input"  />
                                                    <label class="custom-control-label" for="job">Jobs coming from last:</label>
                                                </div>
                                            </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 col-12">
                                        <div class="form-group">
                                            <button class="btn btn-primary" type="submit" style="width: 100%;height: max-content;margin-top: 22px;">Show</button>
                                        </div>
                                    </div>
                                </div>
                            </form>

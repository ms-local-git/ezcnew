            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Warehouse Inventory</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">

                                    <li class="breadcrumb-item active">Location wise report
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?= base_url() ?>/ware_inventory/location_report" method="post">
                                    <div class="row">
                                        <div class="col-sm-2 col-12">
                                            <div class="form-group">
                                                <label for="invalid-state" style="padding-top: 9px;"><b>Account No:                                                   </b></label>
                                            </div>
                                        </div>
                                        <div class="col-sm-8 col-12">
                                            <div class="form-group">
                                                <input type="text" class="form-control " name="account_no"
                                                    placeholder="" value="<?= $request->getPost('account_no') ?>" />
                                            </div>
                                        </div>
                                        <div class="col-sm-2 col-12">
                                            <div class="form-group">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            foreach($reports as $r) {
                                $i++;
                                if($r['serial_loc']!=$serial_loc) {
                                    if($i!=1) {
                        ?>
                                </tbody>
                                </table>
                                <?php } ?>
                                <table class="datatables-basics table display responsive nowrap" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th colspan="10"><?= $r['serial_loc'] ?></th>
                                        </tr>
                                        <tr>
                                            <th>Account No</th>
                                            <th>GatePass #</th>
                                            ...
                                            <th>Serial No</th>
                                            <th>Weight</th>
                                            <th>EZ Inventory id</th>
                                            <th>Tracking No</th>
                                            <th>Company Part Location</th>
                                            <th>Entered Date</th>
                                            <th>Available</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?= $r['account_no'] ?></td>
                                            <td><strong><?= $r['gatepass_no'] ?></strong></td>
                                            <td><?= $r['part_no'] ?></td>
                                            <td><?= $r['serial_no'] ?></td>
                                            <td><?= $r['weight'] ?></td>
                                            <td><?= $r['inventory_id'] ?></td>
                                            <td><?= $r['tracking_no'] ?></td>
                                            <td><?= get_comp_part_loc($r['part_no']) ?></td>
                                            <td><?= date('d-m-Y H:i:s',strtotime($r['entered_date'])) ?></td>
                                            <td>________</td>
                                        </tr>
                                        <?php $serial_loc=$r['serial_loc']; } } ?>
                                    </tbody>
                                </table>
                            </div>
                        </div>

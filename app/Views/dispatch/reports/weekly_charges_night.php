...
<head>
    ...
    ?>
    <title>Weekly Charges Night Shift</title>
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Driver Weekly Charges (Night Shift)
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card p-4" id="searchBox">
                            <form id="searchForm" action="<?= base_url() ?>/dispatch_reports/weekly_charges_night" method="post">
                                <div class="row">

...
<head>
    ...
    ?>
    <title>Missing Driver Charges</title>
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Missing Driver Charges
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card p-4" id="searchBox">
                            <form id="searchForm" action="<?= base_url() ?>/dispatch_reports/missing_dr_charges" method="post">
                                <div class="row">
                                    <label class="col-md-2"><h3>To Date</h3></label>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            if(check_agent($r["id"])==0) {
                                        ?>
                                        <tr>
                                            <td><?= h_gdate($r["dr_datetime"]) ?></td>
                                            <td><?= $r["code"] ?> - <?= $r["first_name"] ?></td>
                                            <td><?= $r["cnt"] ?></td>
                                        </tr>
                                        <?php } } } ?>
                                    </tbody>

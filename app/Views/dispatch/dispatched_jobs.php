                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Dispatched jobs
                                    </li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <table class="datatables-basic table display nowrap responsive" style="width: 100%;">
                                    ...
                                    <tbody id="searchContent">
                                        <?php 
                                            ...
                                            $str1=get_driver($r["driver_id"]);
                                        ?>
                                        <tr>
                                            <td>
                                                <B><?= h_gdate($r["dr_datetime"]) ?><br>
                                                <?= h_gtime($r["dr_datetime"]) ?></B>
                                            </td>
                                            <td><?= $r["job_no"]?></td>							  
                                            <td><?=strtoupper($r["account_no"])?></td>
                                            <td><i><?=$r["reference_no"]?></i></td>
                                            <td><?=$r["from_city"]?></td>							  
                                            <td><?= h_gdate($r["from_date"])?><br><?=h_gtime($r["from_time"]) ?></td>							  							  							  
                                            <td><?= $r["to_city"]?></td>
                                            <td><?=  h_gdate($r["to_date"])?><br><?=h_gtime($r["to_time"])?></td>
                                            <td><?= strtoupper($r["phase"])?></td>
                                            <td><B><?= $str1 ?></b></td>
                                        </tr>
                                        <?php } } ?>
                                    </tbody>

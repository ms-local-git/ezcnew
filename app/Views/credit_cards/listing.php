...
<head>
    ...
    ?>
    <title>Credit Card Listing</title>
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Credit Card Listing</h2>
                            ...
                            <div class="card-datatable">
                                ...
                                <table class="datatables-basic table">
                                    ...
                                    <tbody id="searchContent">
                                        <?php 
                                            if(isset($ccnotes))
                                            foreach($ccnotes as $r) { ?>
                                        <tr>
                                            <td><?= $r['job_id'] ?></td>
                                            <td><?= $r['job_no'] ?></td>
                                            <td><?= $r['amount'] ?></td>
                                            <td><?= $r['notes'] ?>  </td>
                                            <td><a href="ccnotes/edit/<?= $r['id'] ?>">edit</a></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>

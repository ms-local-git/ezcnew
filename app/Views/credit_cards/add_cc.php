                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card p-2" id="searchBox">
                            <form id="searchForm" action="<?= base_url() ?>/credit_cards/save_cc" method="post">
                                <div class="row">
                                    <label class="col-md-3" style="padding-top:9px;"><strong>Credit Card: </strong></label>
                                    <select name="credit_card" id="searchVal" class="form-control col-md-6">
                                ...
                                <br>
                                <div class="row">
                                    <label class="col-md-3" style="padding-top:9px;"><strong>Last Four of Credit Card  </strong></label>
                                    <input type="text" name="last_four" class="form-control col-md-6" required>
                                </div>
                                <br>
                                <div class="row">
                                    <label class="col-md-3" style="padding-top:9px;"><strong>Amount: </strong></label>
                                    <input type="text" name="amount" class="form-control col-md-6" required>
                                </div>
                                <br>
                                <div class="row">
                                    <label class="col-md-3" style="padding-top:9px;"><strong>Date: </strong></label>
                                    <input type="date" name="date1" class="form-control col-md-6" required>
                                </div>
                                <br>
                                <div class="row">
                                    <label class="col-md-3" style="padding-top:9px;"><strong>Notes: </strong></label>
                                    <textarea name="notes" class="form-control col-md-6"></textarea>
                                </div>
                                <div class="">

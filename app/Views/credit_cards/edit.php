               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="card">
                        ...
                        <div class="card-body">
                           <form action="<?= base_url() ?>/Ccnotes/update" method="POST" enctype="multipart/form-data">
                           <div class="row">
                     <div class="col-md-12">
                        <div class="card">
                              ...
                              <div class="row">
                                 ...
                                 <option value="1">Job#</option>
                                      ...
                                      <div class="col-sm-6 col-6">
                                       <input type="text" name="job_no" class="form-control" value="<?= $row['job_no'] ?>">
                                      </div>
                                        </div>
                                    </div>
                                 </div>
                              ...
                              <div class="row">
                                 <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-9 col-6">
                                 <textarea class="form-control" name="notes" rows="3"><?php echo htmlspecialchars($row["notes"]); ?>
                                    </textarea>
                                      </div>
                                        </div>
                                    </div>

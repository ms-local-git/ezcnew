            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Credit Card Pay Report</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                   
                                    <li class="breadcrumb-item active">Pay Report
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url() ?>/credit_cards/pay_report" method="post">
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 col-12">
                                    <div class="form-group">
                                    <label for="invalid-state"><b>Job/Ref #: </b></label>
                                    <input type="text" class="form-control " name="ref_no" value="<?= $request->getPost('ref_no') ?>" />
                                    </div>
                                </div>
                                <div class="col-sm-3 col-12">
                                    <div class="form-group">
                                    <label for="invalid-state"><b>Amt: </b></label>
                                    <input type="text" class="form-control " name="amount" value="<?= $request->getPost('amount') ?>" />
                                    </div>
                                </div>
                            </div> 
                            </form>
                                ...
                                <table class="datatables-basic table">
                                    ...
                                    <?php 
                                        ...
                                        foreach($reports as $r) {
                                            $notes="";
                                            if($r["trans_type"]=='online') $notes=' Online Order Booking';
                                            if($r["trans_type"]=='offline') $notes=$r["notes"];
                                        ?>
                                            <tr>
                                                <td><?= $r['id'] ?></td>
                                                <td><?= $r['gateway_trans_no'] ?></td>
                                                <td><?= $r['own_name'] ?></td>
                                                <td><?= $r["job_no"] ?><BR><?= $r["reference_no"] ?></td>
                                                <td><?= number_format($r['cc_amt']) ?></td>
                                                <td><?= $notes ?></td>
                                                <td><?= $r['hear_us'] ?></td>
                                                <td><?= $r['date_time'] ?></td>
                                            </tr>
                                            <?php $tot_job=$tot_job+$r["cc_amt"]; } ?>
                                        <tr>
                                            <td colspan="2"></td>
                                            <td>Total</td>
                                            <td></td>

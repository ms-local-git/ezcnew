                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="addbtn">
                                            <button type="button" class="btn btn-create">Create Dirctory</button>
                                        </div>
                                    </div>
                                    <div class="card-body loader-2">
                                      
                                            <div class="row">
                                                <?php foreach ($dpt_records as $dptdir) { 
                                                    // echo "<pre>";
                                                    // print_r($dptdir);
                                                    // die;
                                                    ?>
                                                    <div class="col-sm-3 col-12">
                                                        <div class="folder_icons">
                                                            <a href="<?= base_url('dpt/' . $dptdir['id'])?>" class="loaderbtn load-page">
                                                                <i class="fa fa-folder fa-2x"  style="color: #FFD43B; font-size: 65px; margin-top: 23px; margin-left: 87px;"></i>
                                                            </a>
                                                            <h4 class="file_name"><?= $dptdir['name'] ?></h4>
                                                        </div>
                                                    </div>
                                                <?php } ?>
                                            </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?php echo base_url('adddptdir') ?>" method="post" enctype="multipart/form-data">
                                            <div class="row">
...
<style>
    .folder_icons{
        ...
        margin-top: 19px;
        transition: all 250ms cubic-bezier(0.85, 0.4, 0.85, 1.2);

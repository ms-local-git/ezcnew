...
<head>
  ...
  $page_title = "B Price Table";
  ?>
  <title>B Price Table</title>
...
<div="vertical-layout vertical-menu-modern navbar-floating footer-static " data-open=" click" data-menu="vertical-menu-modern" data-col="">
                ...
                <div class="card-body" style="border: 1px solid #8080802e;">
                  <div class="row">
                    <div class="col-sm-12 col-12 mt-1">
                      <div class="row">
                        <div class="col-md-5">
                          <input type="hidden" name="id" value="<?= $bptrecord_data['id']; ?>">
                          <label for="valid-state"><b>BPT Name :</b> <span style="color:red">*</span></label>
                        </div>
                        <div class="col-md-2"></div>
                        <div class="col-md-5">
                          <input type="text" class="form-control" name="bpt_name" value="<?= $bptrecord_data['name']; ?>" placeholder="">
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-12 col-12 mt-1">
                      <div class="row">
                        ...
                        <div class="col-md-2"></div>
                        <div class="col-md-5">
                          <input type="text" class="form-control " name="bpt_description" value="<?= $bptrecord_data['description']; ?>" />
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card-body" style="border: 1px solid #8080802e;">
                <div class="row">
                  <div class="col-sm-12 col-12 mt-1">
                    <div class="row">
                      <div class="col-md-5">
                        <label for="valid-state"><b>copy Bpt Form:</b> <span style="color:red">*</span></label>
                      </div>
                      <div class="col-md-2"></div>
                      <div class="col-md-5">
                        <select class="form-control" onchange="GetUserRecord(this.value)" name="startup">
                          <?php foreach ($bpt_recordsdata as $data) {
                          ?>
                            <option value="<?= $data['id'] ?>" <?= ($data['id'] == $bpt_id) ? 'selected' : '' ?>>
                              <?= $data['name'] ?>
                            </option>
            ...
            <div class="">
              <div class="form-group toggle-form-group">
                ...
                <label class="switch" for="miles_formula">
                  <input type="checkbox" <?= $bptrecord_data['miles_for'] == '1' ? 'checked' : '' ?> id="miles_formula" name="miles_formula" />
              ...
              <form id="milesranform" method="post" enctype="multipart/form-data">
                <div class="form-group toggle-form-group">
                  ...
                  <label class="switch" for="miles_range">
                    <input type="checkbox" id="miles_range" <?= $bptrecord_data['miles_ran'] == '1' ? 'checked' : '' ?> name="miles_range" />
                    <div class="slider round"></div>
                  </label>
                </div>
                  ...
                  <div class="col-sm-6 col-12" style="margin-left: 134px; margin-top: 92px;">
                    <div class="form-group d-flex">
                      ...
                      <label class="switch" for="County">
                        <input type="hidden" id="bpt_id" id="bpt_id" value="<?= $bptrecord_data['id'] ?>" />
                        <input type="checkbox" id="County" <?= $bptrecord_data['is_county'] == '1' ? 'checked' : '' ?> name="county" />
                        <div class="slider round"></div>
                      </label>
                    </div>
                  </div>
            ...
            <div class="card-body county-div">
              <form
                ...
                <div class="row-county">
                  <?php
                  $i = 0;
                  foreach ($bptcounty as $county_record) { ?>
            ...
            <div class="text-center">
              <div class="form-group toggle-form-group">
                ...
                <label class="switch" for="weight_byformula">
                  <input type="checkbox" <?= $bptrecord_data['weight_for'] == '1' ? 'checked' : '' ?> id="weight_byformula" name="weight_byformula" />
                  <div class="slider round"></div>
                </label>
              </div>
              <div class="card-body">
            ...
            <form id="userweightingform" method="POST" enctype="multipart/form-data">
              <div class="form-group toggle-form-group">
                ...
                <label class="switch" for="weight_byrange">
                  <input type="checkbox" id="weight_byrange" <?= $bptrecord_data['weight_ran'] == '1' ? 'checked' : '' ?> name="weight_byrange" />
                  <div class="slider round"></div>
                </label>
              </div>
          </div>
              ...
              <div class="">
                <div class="form-group toggle-form-group">
                  ...
                  <label class="switch" for="waiting_byformula">
                    <input type="checkbox" <?= $bptrecord_data['waiting_for'] == '1' ? 'checked' : '' ?> id="waiting_byformula" name="waiting_byformula" />
                    <div class="slider round"></div>
                  </label>
                </div>
              </div>
              ...
              <form id="userwaitingForm" method="post" enctype="multipart/form-data" action="">
                ...
                <div class="form-group toggle-form-group">
                  ...
                  <label class="switch" for="waiting_byrange">
                    <input type="checkbox" id="waiting_byrange" <?= $bptrecord_data['waiting_ran'] == '1' ? 'checked' : '' ?> name="waiting_byrange" />
                    <div class="slider round"></div>
                  </label>
                </div>
                  ...
                  <div class="row service_charge_<?= $i ?>">
                    ...
                    <div class="col-sm-3 col-12">
                      <div class="form-group second-text-filed">
                        ...
                        <input type="hidden" class="service_charges_id_<?= $i; ?>" value="<?php if (isset($bptCharges[$i])) {
                                                                                            echo $bptCharges[$i]['id'];
                                                                                          }   ?>" />
                        <input type="text" id="" class="form-control myform-input service_charge_name_<?= $i; ?>" value="<?php if (isset($bptCharges[$i])) {
                                                                                                                            echo $bptCharges[$i]['chr_name'];
                                                                                                                          }   ?>" name="charges_name[]>" />
                        <input type="hidden" name="service_charge_id" value="<?php if (isset($bptCharges[$i])) {
                                                                                echo $bptCharges[$i]['id'];
                                                                              }   ?>" />
                      </div>
                    ...
                    <div class="col-sm-4 col-12">
                      <div class="form-group second-text-filed">
                        ...
                        <input type="text" class="form-control myform-input service_chrg_amt_<?= $i; ?>" class="" name="chrg_name[]" placeholder="" value="<?php if (isset($bptCharges[$i])) {
                                                                                                                                                              echo $bptCharges[$i]['chr_amt'];
                                                                                                                                                            } ?>">
                      </div>
                    ...
                    <div class="col-sm-3 col-12">
                      <div class="form-group d-flex" style=" justify-content: space-between;align-items: center;">
                        ...
                        <label class="switch" for="service-fix-<?= $i; ?>">
                          <input type="checkbox" class="checkbox-service service_fix_<?= $i; ?>" onclick="serviceChargesCheckbox('service-fix-<?= $i; ?>','service-per-<?= $i; ?>','fixed')" <?php if (isset($bptCharges[$i]) && $bptCharges[$i]['per_fix'] == 'fixed') {
                                                                                                                                                                                                echo "checked";
                                                                                                                                                                                              }   ?> id="service-fix-<?= $i; ?>"
                        ...
                        <label class="switch" for="service-per-<?= $i; ?>">
                          <input type="checkbox" class="checkbox-service service_per_<?= $i; ?>" onclick="serviceChargesCheckbox('service-per-<?= $i; ?>','service-fix-<?= $i; ?>','per')" <?php if (isset($bptCharges[$i]) && $bptCharges[$i]['per_fix'] == 'per') {
                                                                                                                                                                                              echo "checked";
                ...
                <div class="row">
                  <div class="col-sm-12 col-12 mt-1">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-2"></div>
                      <div class="col-md-5">
                        <input type="text" class="form-control" name="fuel" placeholder="" value="<?= isset($bptrecord_data['fuel']) ? $bptrecord_data['fuel'] : '' ?>">
                      </div>
                    </div>
                  </div>
                </div>
                              ...
                              <div align="center">
                                ...
                                <div class="t-text-wrap">
                                  <label class="switch" for="weekend_charges">
                                    ...
                                    <input type="checkbox" id="weekend_charges" name="weekend_charges" <?= $bptrecord_data['is_weekend'] == '1' ? 'checked' : '' ?> />
                                    <div class="slider round"></div>
                                  </label>
                                      ...
                                      <td width="88" height="19">
                                        <div class="d-flex align-items-center py-1" align="center">
                                          <label class="switch" for="Weekend_fixed">
                                            <input type="checkbox" id="Weekend_fixed" name="Weekend_fixed" <?= $bptrecord_data['weekend_per_fix'] == 'fixed' ? 'checked' : '' ?> />
                                            <div class="slider round"></div>
                                          </label>
                                      ...
                                      <td width="88">
                                        <div class="d-flex align-items-center py-1" align="center">
                                          <label class="switch" for="Weekend_Per">
                                            <input type="checkbox" <?= $bptrecord_data['weekend_per_fix'] == 'per' ? 'checked' : '' ?> id="Weekend_Per" name="Weekend_Per" />
                                            <div class="slider round"></div>
                                          </label>
                                    ...
                                    <tr>
                                      <td height="44" colspan="2">
                                        <div class="d-flex align-items-center v-input " align="center">
                                          ...
                                          <input name="weekend_value" type="text" class="form-control " value="<?= $bptrecord_data['weekend_value'] ?>" id="weekend_value" size="6" maxlength="6" value="">
                                        </div>
                                      </td>
                                    </tr>
                                  </tbody>
                              ...
                              <div align="center">
                                ...
                                <div class="t-text-wrap">
                                  <label class="switch" for="holiday">
                                    <input type="checkbox" <?= $bptrecord_data['is_holiday'] == '1' ? 'checked' : '' ?> id="holiday" name="holiday" />
                                    <div class="slider round"></div>
                                  </label>
                                  ...
                                  <tbody>
                                      ...
                                      <td width="88" height="19">
                                        <div class="d-flex align-items-center py-1" align="center">
                                          <label class="switch" for="holiday_fixed">
                                            <input type="checkbox" <?= $bptrecord_data['holiday_per_fix'] == 'fixed' ? 'checked' : '' ?> id="holiday_fixed" name="holiday_fixed" />
                                            <div class="slider round"></div>
                                          </label>
                                      ...
                                      <td width="88">
                                        <div class="d-flex align-items-center py-1" align="center">
                                          <label class="switch" for="holiday_per">
                                            <input type="checkbox" <?= $bptrecord_data['holiday_per_fix'] == 'per' ? 'checked' : '' ?> id="holiday_per" name="holiday_per" />
                                            <div class="slider round"></div>
                                          </label>
                                          <span class="form_note2">Per.
                                            %</span>
                                    ...
                                    <tr>
                                      <td height="44" colspan="2">
                                        <div class="d-flex align-items-center v-input " align="center">
                                          <span class="form_heading">Value :</span>
                                          <input name="holiday_value" value="<?= $bptrecord_data['holiday_value'] ?>" type="text" class="form-control " id="" name="holiday_value" size="6" maxlength="6" value="">
                                        </div>
                                      </td>
                                    </tr>
                                  </tbody>
                              ...
                              <div align="center">
                                ...
                                <div class="t-text-wrap">
                                  <label class="switch" for="night_charges">
                                    ...
                                    <input type="checkbox" <?= $bptrecord_data['is_night'] == '1' ? 'checked' : '' ?> id="night_charges" name="night_charges" />
                                      ...
                                      <td width="88" height="19">
                                        <div class="d-flex align-items-center py-1" align="center">
                                          <label class="switch" for="night_fixed">
                                            <input type="checkbox" <?= $bptrecord_data['night_per_fix'] == 'fixed' ? 'checked' : '' ?> id="night_fixed" name="night_fixed" />
                                            <div class="slider round"></div>
                                          </label>
                                          <span class="form_note2">Fixed</span>
                                        </div>
                                      ...
                                      <td width="88">
                                        <div class="d-flex align-items-center py-1" align="center">
                                          <label class="switch" for="night_per">
                                            <input type="checkbox" id="night_per" name="night_per" <?= $bptrecord_data['night_per_fix'] == 'per' ? 'checked' : '' ?> />
                                            <div class="slider round"></div>
                                          </label>
                                          <span class="form_note2">Per.
                                            %</span>
                                    ...
                                    <tr>
                                      <td height="44" colspan="2">
                                        <div class="d-flex align-items-center v-input " align="center">
                                          ...
                                          <input name="night_from" type="time" class="form-control input2" value="<?= $bptrecord_data['night_from'] ?>" id="night_form1" size="6" maxlength="6" value="">
                                        </div>
                                        <div class="d-flex align-items-center v-input " style="border-bottom: 1px solid #e2e2e2" ; padding:6px;" align="center">
                                          ...
                                          <input name="night_to" type="time" class="form-control input2 " value="<?= $bptrecord_data['night_to'] ?>" id="night_to2" size="6" maxlength="6" value="">
                                        </div>
                                        <div class="d-flex  align-items-center v-input " align="center">
                                          <span class="form_heading2">From Time :</span>
                                          <input name="night_from2" type="time" class="form-control input2" value="<?= $bptrecord_data['night_from2'] ?>" id="night_form2" size="6" maxlength="6" value="">
                                        </div>
                                        <div class="d-flex align-items-center v-input" style="border-bottom: 1px solid #e2e2e2 ; padding:6px;" align="center">
                                          <span class="form_heading2">To Time :</span>
                                          <input name="night_to2" type="time" class="form-control input2 " id="night_to2" size="6" maxlength="6" value="<?= $bptrecord_data['night_to2'] ?>" value="">
                                        </div>

                                        <div class="d-flex align-items-center v-input " align="center">
                                          <span class="form_heading2">value :</span>
                                          <input name="night_value" type="text" class="form-control input2 " value="<?= $bptrecord_data['night_value'] ?>" id="night_value" size="6" maxlength="6" value="">
                                        </div>
                                      </td>
                                    </tr>
                            ...
                            <table>
                              <tr class="t-text-wrap">
                                <td><label class="switch" for="apply">
                                    ...
                                    <input type="checkbox" <?= $bptrecord_data['is_higher'] == '1' ? 'checked' : '' ?> id="apply" name="apply" />
  ...
  <script>
    ...
    $(document).ready(function() {
      $('.county-btn').on('click', function(event) {
        ...
        let bpt_id = $('#bpt_id').val();


        formData += '&bpt_id=' + encodeURIComponent(bpt_id) + '&act=add_county';
    ...
    $('.milesranbtn').on('click', function(event) {
      ...
      milesformdata += '&bpt_id=' + encodeURIComponent(bpt_id) + '&act=add_milesran';
    ...
    $('.weight-btn').on('click', function(event) {
      ...
      weightformdata += '&bpt_id=' + encodeURIComponent(bpt_id) + '&act=add_weight';
    ...
    $('.waiting-btn').on('click', function(event) {
      ...
      waitingformdata += '&bpt_id=' + encodeURIComponent(bpt_id) + '&act=add_waiting';
    ...
    //       $.ajax({
    //         url: `<?= base_url('BptController/GetUserallData') ?>?id=${id}`,
    //         method: 'GET',
    //         dataType: 'json',
    //         success: function(data) {
    //           $.each(data.bptCharges, function(index, item) {
    ...
    //             $("#weight_byformula").val(data.bpt_recordsdata.weight_for == '1');
    //             $('#weight_byformula').prop('checked', data.bpt_recordsdata.weight_for == 1);
    //           }
    ...
    //             $("#weight_byrange").val(data.bpt_recordsdata.weight_ran == '1');
    //             $('#weight_byrange').prop('checked', data.bpt_recordsdata.weight_ran == 1);
    //           }
    ...
    //             $("#miles_formula").val(data.bpt_recordsdata.miles_for == '1');
    //             $('#miles_formula').prop('checked', data.bpt_recordsdata.miles_for == 1);
    //           }
    ...
    //             $("#miles_range").val(data.bpt_recordsdata.miles_ran == '1');
    //             $('#miles_range').prop('checked', data.bpt_recordsdata.miles_ran == 1);
    //           }

    //           // pallets
    //           if (data.bpt_recordsdata) {
    //             $('input[name="min_pallets"]').val(data.bpt_recordsdata.min_pallets);
    //             $('input[name="min_charge"]').val(data.bpt_recordsdata.pallets_min_char);
    //             $('input[name="per_Pallets_charge"]').val(data.bpt_recordsdata.pallets_per_char);
    //           }
    ...
    //             $("#waiting_byformula").val(data.bpt_recordsdata.waiting_for == '1');
    //             $('#waiting_byformula').prop('checked', data.bpt_recordsdata.waiting_for == 1);
    //           }
    ...
    //             $("#waiting_byrange").val(data.bpt_recordsdata.waitingran == '1');
    //             $('#waiting_byrange').prop('checked', data.bpt_recordsdata.miles_ran == 1);
    //           }

    //           // fuel charges
    //           if (data.bpt_recordsdata) {
    //             $('input[name="fuel"]').val(data.bpt_recordsdata.fuel);
    //           }

    //           // weekend charges
    //           if (data.bpt_recordsdata) {
    //             $("#weekend_charges").val(data.bpt_recordsdata.is_weekend == '1');
    //             $('#weekend_charges').prop('checked', data.bpt_recordsdata.is_weekend == 1);
    //             $('#Weekend_fixed').prop('checked', data.bpt_recordsdata.weekend_per_fix === 'fixed');
    //             $('#Weekend_Per').prop('checked', data.bpt_recordsdata.weekend_per_fix === 'per');
    //             $('input[name="weekend_value"]').val(data.bpt_recordsdata.weekend_value);
    //           }

    //           // holiday charges
    //           if (data.bpt_recordsdata.is_holiday) {
    //             $("#holiday").val(data.bpt_recordsdata.is_holiday == '1');
    //             $('#holiday').prop('checked', data.bpt_recordsdata.is_holiday == 1);
    //             $('#holiday_fixed').prop('checked', data.bpt_recordsdata.holiday_per_fix === 'fixed');
    //             $('#holiday_per').prop('checked', data.bpt_recordsdata.holiday_per_fix === 'per');
    //             $('input[name="holiday_value"]').val(data.bpt_recordsdata.holiday_value);
    //           }

    //           // night charges
    //           if (data.bpt_recordsdata.is_night) {
    //             $("#night_charges").val(data.bpt_recordsdata.is_night == '1');
    //             $('#night_charges').prop('checked', data.bpt_recordsdata.is_night == 1);
    //             $('#night_fixed').prop('checked', data.bpt_recordsdata.night_per_fix === 'fixed');
    //             $('#night_per').prop('checked', data.bpt_recordsdata.night_per_fix === 'per');
    //             $('input[name="night_from"]').val(data.bpt_recordsdata.night_from);
    //             $('input[name="night_to"]').val(data.bpt_recordsdata.night_from2);
    //             $('input[name="night_from2"]').val(data.bpt_recordsdata.holiday_value);
    //             $('input[name="night_to2"]').val(data.bpt_recordsdata.night_to2);
    //             $('input[name="night_value"]').val(data.bpt_recordsdata.night_value);
    //           }

    //           // name and description
    //           if (data.bpt_recordsdata) {
    //             $('input[name="bpt_name"]').val(data.bpt_recordsdata.name);
    //             $('input[name="bpt_description"]').val(data.bpt_recordsdata.description);
    //           }

    //           // county
    //           var html3 = ``;
    //           $.each(data.bptcounty, function(index3, item3) {
    //             html3 += `
    //       <div class="row">
    //         <div class="col-sm-4 col-12">
    //           <div class="form-group">
    ...
    //           $("#County").val(data.bpt_recordsdata.is_county == '1');
    //           $('#County').prop('checked', data.bpt_recordsdata.is_night == 1);

    //           // higher charges
    //           $("#apply").val(data.bpt_recordsdata.is_higher == '1');
    //           $('#apply').prop('checked', data.bpt_recordsdata.is_higher == 1);
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            if (data.waitingran) {
              ...
              $('input[name="weight_time_charges"]').val(data.waitingran.value1);
              $("#waiting_byrange").val(data.bpt_recordsdata.waitingran == '1');
              $('#waiting_byrange').prop('checked', data.bpt_recordsdata.waitingran == 1);
            }
            ...
            $("#County").val(data.bpt_recordsdata.is_county == '1');
            $('#County').prop('checked', data.bpt_recordsdata.is_county == 1);
    ...
    function copyform(copyformdata) {
      ...
      var copyformdata = {
        bpt_id: bpt_id,
        bptCharges: copyformdata.bptCharges,
        bpt_recordsdata: copyformdata.bpt_recordsdata,
        bptcounty: copyformdata.bptcounty,
        bptrecord_data: copyformdata.bptrecord_data,
      ...
      $.ajax({
        url: '<?= base_url('bptController/copybptForm') ?>',
        method: 'POST',
        dataType: 'json',
        data: copyformdata,
        success: function(response) {
  ...
  <script>
    $('.submitbtn').click(function(event) {
      ...
      let bpt_name = $('input[name="bpt_name"]').val();
      let bpt_description = $('input[name="bpt_description"]').val();
      ...
      let mainformData = {
        bpt_id: bpt_id,
        bpt_name: bpt_name,
        bpt_description: bpt_description,
      ...
      $.ajax({
        type: 'POST',
        url: '<?= base_url('insertbpt') . '?act=mainformdata' ?>&bpt_id=' + encodeURIComponent(bpt_id),
        data: formData,
        dataType: 'JSON',
        success: function(response) {
